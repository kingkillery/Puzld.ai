...
description: Use when testing Android apps on connected devices via ADB. Triggers on "test device", "test on device", "run device test", "manual test", "adb test", or Android device testing tasks.
---
